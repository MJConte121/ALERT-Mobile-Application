...
import com.example.finalnaaa.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        com.example.finalnaaa.databinding.ActivityMapsBinding binding = ActivityMapsBinding.inflate(getLayoutInflater());
        ...
        locationListener = new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                try {
                    ...
                    nMap.addMarker(new MarkerOptions().position(latLng).title("Locations"));
                    nMap.moveCamera(CameraUpdateFactory.newLatLng(latLng));

                    String phoneNumber = "09353845829";
